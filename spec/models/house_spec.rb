...
RSpec.describe House, type: :model do
  ...
  let(:reservation) do
    Reservation.create(user_id: user.id, house_id: house.id, start_time: '2020-02-20', end_time: '2020-02-21')
  end
  ...
  describe 'class methods' do
    ...
    context 'when there are houses' do
      it 'returns all the houses' do
        house1 = House.create(name: 'Test', rooms: 1, beds: 1, baths: 1, price: 1, rating: 1,
                              image_url: 'www.google.com', description: 'Test', user_id: user.id)
        house2 = House.create(name: 'Test2', rooms: 1, beds: 1, baths: 1, price: 1, rating: 1,
                              image_url: 'www.google.com', description: 'Test', user_id: user.id)
  ...
  describe 'instance methods' do
    ...
    context 'when there are reservations' do
      it 'returns all the reservations' do
        reservation1 = Reservation.create(user_id: user.id, house_id: house.id, start_time: '2020-02-20',
                                          end_time: '2020-02-21')
        reservation2 = Reservation.create(user_id: user.id, house_id: house.id, start_time: '2020-02-20',
                                          end_time: '2020-02-21')
